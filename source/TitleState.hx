	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['GAMERMEER'], 15);
					#else
					createCoolText(['GAMERMEER']);
					#end
				// credTextShit.visible = true;
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('no one', 15);
					addMoreText('nobody', 15);
					addMoreText('sus', 15);
					#else
					addMoreText('gltichmod presents');
					#end
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Glitch'); // credTextShit.text += '\nFunkin';
